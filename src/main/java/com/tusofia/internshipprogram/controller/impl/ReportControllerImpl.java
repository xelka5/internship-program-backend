...
import com.tusofia.internshipprogram.controller.ReportController;
...
/**
 * Url mapping and implementation of {@link ReportController}
 *
 * @author DCvetkov
 * @since 2020
 */
...
public class ReportControllerImpl implements ReportController {
  ...
  public InternReportDto getInternReport(@PathVariable String reportTrackingNumber,
  ...
  public List<InternReportDto> getInternReportsForInternship(@PathVariable String internshipTrackingNumber,
                                                             Authentication authentication) {
  ...
  @PostMapping
  public BaseResponseDto createReport(@RequestBody InternReportDto internReport,
                                      Authentication authentication) {
  ...
  public BaseResponseDto editReport(@RequestBody InternReportDto internReport,
                                    @PathVariable String reportTrackingNumber,
                                    Authentication authentication) {
  ...
  public BaseResponseDto removeReport(@PathVariable String reportTrackingNumber,
                                      Authentication authentication) {
