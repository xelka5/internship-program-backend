...
public class ApplicationResponseMail extends EmailMessageHolder {
  ...
  public MimeMessage createEmailMessageContent(MimeMessage mimeMessage) {
    ...
    try {
      ...
      htmlMsg = htmlMsg.replace("{{internshipTitle}}", internshipTitle)
