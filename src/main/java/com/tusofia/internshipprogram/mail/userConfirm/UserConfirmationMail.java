...
public class UserConfirmationMail extends EmailMessageHolder {
  ...
  public MimeMessage createEmailMessageContent(MimeMessage mimeMessage) {
    ...
    try {
      ...
      htmlMsg = htmlMsg.replace("{{environmentUrl}}", environmentUrl)
